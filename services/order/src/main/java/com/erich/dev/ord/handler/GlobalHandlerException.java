package com.erich.dev.ord.handler;


import com.erich.dev.ord.exception.BusinessException;
...
public class GlobalHandlerException {
    ...
    public ProblemDetail handlerBadRequestException(BusinessException e) {
